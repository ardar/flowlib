        ...
        System.IComparable
    {
        ...
        public void Cancel(int pos)
        {
            if (segmentsInProgress != null && segmentsInProgress.Get(pos))
            {
                ...
                SegmentCanceled(this, new FmdcEventArgs(pos));
            }
        }
        ...
        public bool Start(int pos)
        {
            ...
            if (value)
            {
                ...
                SegmentStarted(this, new FmdcEventArgs(pos));
            }
            return value;
        }
