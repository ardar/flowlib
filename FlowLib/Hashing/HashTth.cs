...
namespace FlowLib.Hashing
{
    public class HashTth : IHash
    {
        ...
        public void Generate(ContentInfo info)
        {
        ...
        public bool VerifyData(ref ContentInfo info, string str)
        {
            throw new System.Exception("The method or operation is not implemented.");
        }

        public bool verifySegment(ref ContentInfo info, SegmentInfo seg)
        {
            throw new System.Exception("The method or operation is not implemented.");
        }
    }
