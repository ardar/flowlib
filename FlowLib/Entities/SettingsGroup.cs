    ...
    public class SettingsGroup
    {
        ...
        public SettingItem[] Items
        {
            ...
            set {
              ...
              {
                  item.UpdatedSetting += new EventHandler(item_UpdatedSetting);
        ...
        public event EventHandler UpdatedSetting;
        ...
        */
        ...
        {
            UpdatedSetting = new EventHandler(SettingsGroup_UpdatedSetting);
        }

        void SettingsGroup_UpdatedSetting(object sender, DefaultEventArgs e) { }

        protected void item_UpdatedSetting(object sender, DefaultEventArgs e)
        {
