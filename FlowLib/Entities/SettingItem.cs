    ...
    public class SettingItem
    {
        ...
        public object Value
        {
            ...
            set {
                this.value = value;
                Check();
                UpdatedSetting(this, new DefaultEventArgs(key, value));
            }
        }
        /// <summary>
        ...
        /// </summary>
        public SettingItem() {
            UpdatedSetting = new EventHandler(OnUpdateSetting);
        }
        ...
        protected void OnUpdateSetting(object sender, DefaultEventArgs e)
        {
