...
using Flowertwig.Utils.Conversion;
        ...
        System.IComparable
    {
        ...
        public bool[] SegmentsDownloaded
        {
            get
            {
                lock (this)
                {
                    return FileSizeConverter.BitArrayToBoolArray(segmentsDownloaded);
                }
            }
            set
            {
        ...
        public bool[] SegmentsInProgress
        {
            get
            {
                lock (this)
                {
                    return FileSizeConverter.BitArrayToBoolArray(segmentsInProgress);
                }
            }
            set
            {
        ...
        public DownloadItem()
        {
            this.DownloadCompleted = new EventHandler(DownloadItem_DownloadCompleted);
            this.SegmentCanceled = new EventHandler(DownloadItem_SegmentCanceled);
            this.SegmentCompleted = new EventHandler(DownloadItem_SegmentCompleted);
            this.SegmentStarted = new EventHandler(DownloadItem_SegmentStarted);
        }

        void DownloadItem_SegmentStarted(object sender, DefaultEventArgs e) { }
        void DownloadItem_SegmentCompleted(object sender, DefaultEventArgs e) { }
        void DownloadItem_SegmentCanceled(object sender, DefaultEventArgs e) { }
        void DownloadItem_DownloadCompleted(object sender, DefaultEventArgs e) { }
        ...
        public void Cancel(int pos, Source src)
        {
            ...
            SegmentCanceled(this, new DefaultEventArgs(pos, src));
        }
        ...
        protected bool Start(int pos, Source src, bool lockResources)
        {
            ...
            try
            {
                ...
                if (value)
                {
                    ...
                    SegmentStarted(this, new DefaultEventArgs(pos, src));
                }
            }
            finally
            {
        ...
        public void Finished(int pos, Source src)
        {
            ...
            SegmentCompleted(this, new DefaultEventArgs(pos, src));

            // Tell everyone that this downloadItem is finished
            if (segDoneCount == segTotalCount)
            {
                DownloadCompleted(this, new DefaultEventArgs(0, src));
            }
        }
