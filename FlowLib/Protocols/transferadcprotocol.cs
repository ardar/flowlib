...
namespace FlowLib.Protocols
{
    ...
    public class TransferAdcProtocol : IProtocolTransfer
    {
        ...
        /// </summary>
        protected SUP userSupport = null;
        ...
        public TransferAdcProtocol(ITransfer trans)
            : this(trans, System.AppDomain.CurrentDomain.BaseDirectory)
        {

        }

        public TransferAdcProtocol(ITransfer trans, string dir)
        {
            directory = dir;
            this.trans = trans;
