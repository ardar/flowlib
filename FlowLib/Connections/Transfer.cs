...
namespace FlowLib.Connections
{
    ...
    public class Transfer : TcpConnection, ITransfer
    {
        ...
        /// </summary>
        public event EventHandler DownloadItemChanged;
        ...
        public DownloadItem DownloadItem
        {
            ...
            {
                downloadItem = value;
                DownloadItemChanged(this, new DefaultEventArgs(0, downloadItem));
            }
        }
        ...
        public Transfer(System.Net.Sockets.Socket s)
            : base(s)
        {
            DownloadItemChanged = new EventHandler(OnDownloadItemChanged);
            if (socket.Connected)
            {
        ...
        #region Events
        void OnDownloadItemChanged(object sender, DefaultEventArgs e) { }
        #endregion
    }
}
