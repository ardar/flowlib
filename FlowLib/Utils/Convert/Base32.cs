...
namespace FlowLib.Utils.Convert
{
    ...
    /// Executable\Extras\Hashing\Misc.cs
    /// All credits to Jonathan Bindel.
    /// </summary>
    public sealed class Base32
    {
        ...
        /// <summary>
        /// Solo constructor is private to prevent external instantiation of this class
        /// </summary>
        Base32()
        {
        }
        ...
        /// <summary>
        /// Decode a Base32 string into a decoded string
        /// </summary>
        /// <param name="base32">The Base32 string</param>
        /// <returns>The decoded string</returns>
        public static string DecodeToString(string base32)
        {
            byte[] bytes = Decode(base32);
            return Utils.Convert.General.FromByteArrayToString(bytes);
        }
    }
}
