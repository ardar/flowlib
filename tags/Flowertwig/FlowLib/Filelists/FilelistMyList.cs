    ...
    public class FilelistMyList : BaseFilelist
    {
            ...
            : base(null)
        {
            ...
            else
            {
                ...
                Flowertwig.Utils.Compression.Bz2.Decompress(new System.IO.MemoryStream(content), tmpStream);
                tmpStream.Position = 0;
                sb.Append(Encoding.UTF8.GetString(tmpStream.ToArray()));
            }
            Bz2 = isBz2;
            fromFile = true;
        }
        ...
        protected override void EndFilelist()
        {
            try
            {
                FileOperations.PathExists(ContentInfo.Get(ContentInfo.STORAGEPATH));
                ...
                if (bz2)
                {
                    ...
                    ms.Position = 0;
                    size = Flowertwig.Utils.Compression.Bz2.Compress(ms, baseStream, 512);
                }
                else
                {
