...
using EventHandler = Flowertwig.Utils.Events.EventHandler;
...
namespace FlowLib.Connections
{
    public class Detect : IUPnPUpdater
    {
        ...
        public Detect()
        {
            ...
            upnp.ProtocolUPnP.Update += new EventHandler(OnUPnPUpdate);
            Port = 31173;
        }


        void OnUpdateBase(object sender, DefaultEventArgs e) { }
        ...
        public void FireUpdateBase(DefaultEventArgs e)
        {
            UpdateBase(this, e);
        }
		...
		public void Start(WorkMethod method)
        {
			...
			switch (WorkingMethod)
			{
				...
				case WorkMethod.ThreadInBackground:
			        ...
			        workingThread.Name = "DetectWorker";
					switch (WorkingMethod)
					{
						case WorkMethod.ThreadInBackground:
        ...
        protected virtual void DoInternalListenRecieveAccess()
        {
            try
            {
                ...
                tcpListener.Update += new EventHandler(DoInternalListenAccess_Update);
                tcpListener.Start();
                try
                {
        ...
        protected virtual void DoExternalIp()
        {
            ...
            {
                string content = null;
                // We are now using our own Ip service to make sure we will always get the proper response.
                if ((content = WebOperations.GetPage("http://ip.flowertwig.org/")) != string.Empty)
                {
                    // We are
					// TODO: We shouldn't limit ourself to IPv4. 
        ...
        protected virtual void DoExternalRecieveAccess()
        {
            ...
            {
                tcpListener = new TcpConnectionListener(Port);
                tcpListener.Update += new EventHandler(DoExternalRecieveAccess_Update);
                tcpListener.Start();
        ...
        protected virtual void OnUPnPUpdate(object sender, DefaultEventArgs e)
        {
            var upnp = sender as IUPnP;
            var device = e.Data as UPnPDevice;
            if (upnp != null && device != null)
            {
                switch (e.Action)
                {
                    case Actions.UPnPRootDeviceFound:
						//FlowLib.DefaultEventArgs e3 = new FlowLib.DefaultEventArgs(Actions.UPnPDeviceDescription, device.Information.Sender.ToString());
						//UpdateBase(this, e3);
        ...
        protected virtual void DoUPnPIGD()
        {
            try
            {
                ...
                {
                    DefaultEventArgs e = new DefaultEventArgs(Actions.UPnPDeviceDescription, devicePair.Key);
                    UpdateBase(this, e);
                }
            }
            finally
        ...
        protected virtual void DoUPnPExternalRecieveAccess()
        {
            ...
            {
                tcpListener = new TcpConnectionListener(Port);
                tcpListener.Update += new EventHandler(DoUPnPExternalRecieveAccess_Update);
                tcpListener.Start();
        ...
        protected void DoUPnPExternalRecieveAccess_Update(object sender, DefaultEventArgs e)
        {
            switch (e.Action)
            {
                case Actions.TransferStarted:
                    var trans = e.Data as Transfer;
                    if (trans != null)
                    {
                        ...
                        trans.Protocol.RequestTransfer += DoUPnPExternalRecieveAccess_RequestTransfer;
                        e.Handled = true;
                    }
                    break;
            }
        ...
        protected virtual void DoUPnPExternalRecieveAccess_RequestTransfer(object sender, DefaultEventArgs e)
        {
        ...
        protected void DoExternalRecieveAccess_Update(object sender, DefaultEventArgs e)
        {
            switch (e.Action)
            {
                case Actions.TransferStarted:
                    ...
                    if (trans != null)
                    {
                        ...
                        trans.Protocol.RequestTransfer += DoExternalRecieveAccess_RequestTransfer;
                        e.Handled = true;
                    }
                    break;
            }
        ...
        protected virtual void DoExternalRecieveAccess_RequestTransfer(object sender, DefaultEventArgs e)
        {
            TransferRequest req = e.Data as TransferRequest;
            req = transferManager.GetTransferReq(req.Key);
            if (req != null)
        ...
        protected virtual void DoInternalListenAccess_Update(object sender, DefaultEventArgs e)
        {
            switch (e.Action)
            {
                case Actions.TransferStarted:
                    ...
                    if (trans != null)
                    {
                        ...
                        trans.Protocol.RequestTransfer += DoInternalListenAccess_RequestTransfer;
                        e.Handled = true;
                    }
                    break;
            }
        ...
        protected virtual void DoInternalListenAccess_RequestTransfer(object sender, DefaultEventArgs e)
        {
            TransferRequest req = e.Data as TransferRequest;
            req = transferManager.GetTransferReq(req.Key);
            if (req != null)
